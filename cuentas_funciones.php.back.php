<?php
	...
	function cuentas_menuInicio()
	{
		...
		$selectCuentasActivo = "	SELECT ctasReg.id_ctas_registro AS id
										 ...
										 , ctasReg.id_ctas_contable AS idCta
										 , ctaCont.nombre_ctas_contable AS contable
									FROM
									  ctas_registro ctasReg
									INNER JOIN ctas_contable AS ctaCont ON ctasReg.id_ctas_contable = ctaCont.id_ctas_contable
									WHERE
		...
		while($ctasAct =  siguiente_registro($cuentasActivo))
		{
			$listaCtasAct .= '	<li class="dd-item dd3-item" data-id="'.$ctasAct["id"].'">
									...
									<div class="dd3-content">
										('.utf8_encode($ctasAct["contable"]).')'.utf8_encode($ctasAct["nombre"]).'
			...
			if($ctaHijosNivel1 != 0)
			{
				...
				while($nivel1 = siguiente_registro($hijosNivel1))
				{
					$listaCtasAct .= '<li class="dd-item dd3-item" data-id="'.$nivel1["id"].'">
										  <div class="dd-handle dd3-handle fa fa-th"></div>
											  <div class="dd3-content">
												  ('.utf8_encode($nivel1["contable"]).')'.utf8_encode($nivel1["nombre"]).'
												  <div class="btn-group btnsCuentas">	';												  
												  if($btnAgregar)
						...
						if($ctaHijosNivel2 != 0)
						{
							...
							while($nivel2 = siguiente_registro($hijosNivel2))
							{
								$listaCtasAct .= '<li class="dd-item dd3-item" data-id="'.$nivel2["id"].'">
													  <div class="dd-handle dd3-handle fa fa-th"></div>
													  <div class="dd3-content">
														  ('.utf8_encode($nivel2["contable"]).')'.utf8_encode($nivel2["nombre"]).'
														   <div class="btn-group btnsCuentas">	';
															  if($btnAgregar)
									...
									if($ctaHijosNivel3 != 0)
									{
										...
										while($nivel3 = siguiente_registro($hijosNivel3))
										{
											$listaCtasAct .= '<li class="dd-item dd3-item" data-id="'.$nivel3["id"].'">
																  <div class="dd-handle dd3-handle fa fa-th"></div>
																  <div class="dd3-content">
																	  ('.utf8_encode($nivel3["contable"]).')'.utf8_encode($nivel3["nombre"]).'
																	   <div class="btn-group btnsCuentas">	';
																		  if($btnAgregar)
												...
												if($ctaHijosNivel4 != 0)
												{
													...
													while($nivel4 = siguiente_registro($hijosNivel4))
													{
														$listaCtasAct .= '<li class="dd-item dd3-item" data-id="'.$nivel4["id"].'">
																			  <div class="dd-handle dd3-handle fa fa-th"></div>
																			  <div class="dd3-content">
																				  ('.utf8_encode($nivel4["contable"]).')'.utf8_encode($nivel4["nombre"]).'
																				   <div class="btn-group btnsCuentas">	';
																					  if($btnAgregar)
															...
															if($ctaHijosNivel5 != 0)
															{
																...
																while($nivel5 = siguiente_registro($hijosNivel5))
																{
																	$listaCtasAct .= '<li class="dd-item dd3-item" data-id="'.$nivel5["id"].'">
																						  <div class="dd-handle dd3-handle fa fa-th"></div>
																						  <div class="dd3-content">
																							  ('.utf8_encode($nivel5["contable"]).')'.utf8_encode($nivel5["nombre"]).'
																							   <div class="btn-group btnsCuentas">	';
																									if($btnAgregar)
																	...
																	if($ctaHijosNivel6 != 0)
																	{
																		...
																		while($nivel6 = siguiente_registro($hijosNivel6))
																		{
																			$listaCtasAct .= '<li class="dd-item dd3-item" data-id="'.$nivel6["id"].'">
																								  <div class="dd-handle dd3-handle fa fa-th"></div>
																								  <div class="dd3-content">
																									  ('.utf8_encode($nivel6["contable"]).')'.utf8_encode($nivel6["nombre"]).'
																									   <div class="btn-group btnsCuentas">	';
																											if($btnAgregar)
																			...
																			if($ctaHijosNivel7 != 0)
																			{
																				...
																				while($nivel7 = siguiente_registro($hijosNivel7))
																				{
																					$listaCtasAct .= '<li class="dd-item dd3-item" data-id="'.$nivel7["id"].'">
																									  <div class="dd-handle dd3-handle fa fa-th"></div>
																									  <div class="dd3-content">
																									  ('.utf8_encode($nivel7["contable"]).')'.utf8_encode($nivel7["nombre"]).'
																									   <div class="btn-group btnsCuentas">	';
																											if($btnAgregar)
																					...
																					if($ctaHijosNivel8 != 0)
																					{
																						...
																						while($nivel8 = siguiente_registro($hijosNivel8))
																						{
																							$listaCtasAct .= '<li class="dd-item dd3-item" data-id="'.$nivel8["id"].'">
																												  <div class="dd-handle dd3-handle fa fa-th"></div>
																												  <div class="dd3-content">
																													  ('.utf8_encode($nivel8["contable"]).')'.utf8_encode($nivel8["nombre"]).'
																													   <div class="btn-group btnsCuentas">	';
																															if($btnAgregar)
																							...
																							if($ctaHijosNivel9 != 0)
																							{
																								...
																								while($nivel9 = siguiente_registro($hijosNivel9))
																								{
																									$listaCtasAct .= '<li class="dd-item dd3-item" data-id="'.$nivel9["id"].'">
																														  <div class="dd-handle dd3-handle fa fa-th"></div>
																														  <div class="dd3-content">
																															  ('.utf8_encode($nivel9["contable"]).')'.utf8_encode($nivel9["nombre"]).'
																															   <div class="btn-group btnsCuentas">	';
																																   if($btnEdita)
									...
									<div class="panel panel-danger">
										...
										<div class="panel-body" style="border-radius: 0px;">
											<div class="form-horizontal">
												...
												<div class="form-group">
													<label for="saldoCta" class="col-sm-3 control-label">Tipo:</label>
													<div class="col-sm-6">
														<select id="saldoCta" name="saldoCta" style="width:100% !important" class="selectSerch" onChange="mostrarClases(this.value);">
												...
												<div id="div_saldoCta2" hidden class="form-group">
													<label for="saldoCta2" class="col-sm-3 control-label">Clasificaci&oacute;n:</label>
													<div class="col-sm-6">
														<select id="saldoCta2" name="saldoCta2" style="width:100% !important" class="selectSerch" onChange="obtenerCta(this.value);">
												...
												<div id="div_ctaContable" hidden class="form-group">
													<label for="ctaContable" class="col-sm-3 control-label">Cuenta Contable:</label>
													<div class="col-sm-6">
													    <select name="ctaContable" id="ctaContable" class="selectSerch">
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														<label class="radio-inline">
															<input id="periCta" type="radio" value="1" checked="checked" name="periCta">Obligatorio
														</label>
														<label class="radio-inline">
										...
										<div class="panel-body" style="border-radius: 0px;">
											<div class="form-horizontal">
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														<div class="input-group">
															<input class="form-control" type="text" name="factorCta" id="factorCta" placeholder="0.00" value="'.$cuen["factor"].'">
															<span class="input-group-addon">%</span>
														</div>
													</div>
												</div>										                            
										...
										<div class="panel-footer">
											<div class="row">
												<div class="col-sm-12">
													<div class="btn-toolbar btnsGuarCan">
														<i class="btn-danger btn" onclick="navegar();">Cancelar</i>
														<i class="btn-success btn" onclick="nuevoConceptoEdita(\'GuardarEdit\');">Guardar</i>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="panel-body" style="border-radius: 0px;">
											...
											<div id="div_ctaContable" hidden class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														<div class="input-group">
															<input class="form-control" type="text" name="factorCta" id="factorCta" placeholder="0.00" value="'.$_POST["factorCta"].'">
															<span class="input-group-addon">%</span>
														</div>
													</div>
												</div>
